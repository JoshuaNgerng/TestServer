...
let dropFilesHeading = document.getElementById("no-drop-files-heading");
let insertDriveFileImg = document.querySelector("#drop-area img");
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateFileInput() {
        ...
        const fileInput = document.getElementById("input-file");
        Array.from(filePreview.getElementsByClassName("file-item")).forEach((fileItem) => {
